...
import { Btn, Input, Button, Select } from "../../syledcomponent/StyledComponent";
...
const FilterBar = ({ type }) => {
    ...
    return (
        <>
            <Paper className={type == "list" ? "bookingFied2" : "bookingFied"}>
                <Box className='headerSearch'>
                    <Box className="headerSearchItemSelect">
                    ...
                    <Box className="headerSearchItemButton">
